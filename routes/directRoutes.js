...
router.put("/addfiles/:id", directController.addFiles);
router.put("/updatefile/:id/:fileId", directController.updateFile);
router.delete("/files/:id/:fileId", directController.deleteFile);
